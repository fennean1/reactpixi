...
import ICON from '../../assets/SnowmenLineIcon.png'
...
const sequence = 
    [{
      ...
      tips: ["Students model the situation with the tool.",
      "How many partitions are between JiJi’s igloo and the halfway point?",
        ],
    },
]
