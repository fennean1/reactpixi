    ...
    return (
      ...
      <div style = {{display: 'flex',flexDirection: 'column'}}>
           <div className ="section no-pad-bot" id="index-banner">
             <h1 className ="header center">Ordering and Equivalence</h1>
          </div>
        <div className = "container" style = {{display: 'flex',flexDirection: 'row'}}>
              <Link style = {{flex: 1,margin: "1%",flexDirection: "row"}} to={{pathname: "/equivalencelessons"}}>   
              ...
              <Link style = {{flex: 1,margin: "1%",flexDirection: "row"}} to={{pathname: "/equivalencewordproblems"}}>   
              <Paper elevation = {2} style = {{flex: 1,flexDirection: "row",display:"flex",justifyContent: "center"}}>
